...
func TestEveryRemoteCommandUsesDocumentedOperation(t *testing.T) {
	...
	operations := map[string]commandOperation{
		...
		"playbook owner transfer":      {"patch", "/v1/playbooks/{playbookId}/owner"},
		...
		"case popular":                 {"get", "/v1/cases/popular"},
		"case access get":              {"get", "/v1/cases/{caseId}/access"},
		...
		"case handoff remove":          {"delete", "/v1/cases/{caseId}/handoffs/{handoffId}"},
		"case handoff delete":          {"delete", "/v1/cases/{caseId}/handoffs/{handoffId}"},
		"case handoff graph get":       {"get", "/v1/cases/{caseId}/handoff-graph"},
		"case handoff graph":           {"get", "/v1/cases/{caseId}/handoff-graph"},
		"case handoff candidates list": {"get", "/v1/cases/{caseId}/handoff-candidates"},
		...
		"case task get":                {"get", "/v1/tasks/{taskId}"},
		"case task update":             {"patch", "/v1/tasks/{taskId}"},
		"case task set status":         {"post", "/v1/tasks/{taskId}/status"},
		...
		"case record delete":           {"delete", "/v1/records/{recordId}"},
		"record append":                {"post", "/v1/cases/{caseId}/records"},
		"record list":                  {"get", "/v1/cases/{caseId}/records"},
		"record update":                {"patch", "/v1/records/{recordId}"},
		"record delete":                {"delete", "/v1/records/{recordId}"},
		"task create":                  {"post", "/v1/cases/{caseId}/tasks"},
		"task list":                    {"get", "/v1/tasks"},
		"task get":                     {"get", "/v1/tasks/{taskId}"},
		"task update":                  {"patch", "/v1/tasks/{taskId}"},
		"task set status":              {"post", "/v1/tasks/{taskId}/status"},
		"playbook suggestion create":   {"post", "/v1/playbooks/{playbookId}/suggestions"},
		"playbook suggestion get":      {"get", "/v1/suggestions/{suggestionId}"},
		"playbook suggestion list":     {"get", "/v1/playbooks/{playbookId}/suggestions"},
		"playbook suggestion update":   {"patch", "/v1/suggestions/{suggestionId}"},
		"playbook suggestion resolve":  {"post", "/v1/suggestions/{suggestionId}/resolve"},
		"suggestion create":            {"post", "/v1/playbooks/{playbookId}/suggestions"},
...
func TestQueryCommandOptionsMatchOpenAPI(t *testing.T) {
	...
	routes := map[string]string{
		...
		"case list":                    "/v1/cases",
		"case popular":                 "/v1/cases/popular",
		"case handoff graph get":       "/v1/cases/{caseId}/handoff-graph",
		"case handoff candidates list": "/v1/cases/{caseId}/handoff-candidates",
