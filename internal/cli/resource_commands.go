...
func caseRecordCommands() []*command {
	...
	}, requestBody, true, str("--task-id", "taskId", "Task this Record belongs to"), str("--source-step-id", "sourceStepId", "four-character Step ID"), choice("--kind", "kind", "Record kind", "note", "output"), str("--content", "content", "Record content"), object("--data", "data", "Record data JSON object"), choice("--origin", "origin", "Record origin", "user", "agent"), str("--client-name", "clientName", "client name"), str("--client-version", "clientVersion", "client version"))
	...
	}, requestBody, true, choice("--kind", "kind", "Record kind", "note", "output"), str("--content", "content", "Record content"), object("--data", "data", "Record data JSON object"))
...
func recordCommands() []*command {
	...
	}, requestBody, true, str("--case-id", "caseId", "Case ID"), str("--task-id", "taskId", "Task this Record belongs to"), str("--source-step-id", "sourceStepId", "four-character Step ID"), choice("--kind", "kind", "Record kind", "note", "output"), str("--content", "content", "Record content"), object("--data", "data", "Record data JSON object"), choice("--origin", "origin", "Record origin", "user", "agent"), str("--client-name", "clientName", "client name"), str("--client-version", "clientVersion", "client version"))
