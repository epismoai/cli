...
func TestEveryCommandHasExpectedDryRunSupport(t *testing.T) {
	want := map[string]bool{
		...
		"case start": true, "case access set": true, "case share": true, "case assign": true, "case acl": true, "case update": true, "case review": true, "case handoff": true, "case close": true, "case reopen": true,
