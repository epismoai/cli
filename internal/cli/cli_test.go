...
func TestCommandSurface(t *testing.T) {
	expected := strings.Fields(`
		...
		case/start case/get case/list case/popular case/access/get case/access/set case/share case/assign case/acl case/update case/review case/handoff case/handoff/graph case/handoff/candidate/list case/close case/reopen
