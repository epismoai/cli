...
func TestCommandSurface(t *testing.T) {
	expected := strings.Fields(`
		...
		case/start case/get case/list case/popular case/access/get case/access/set case/share case/assign case/acl/set case/acl case/update case/review case/overview case/handoff/create case/handoff case/handoff/remove case/handoff/delete case/handoff/graph/get case/handoff/graph case/handoff/candidates/list case/handoff/candidate/list case/close case/reopen
